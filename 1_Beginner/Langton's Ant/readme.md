# Langton's Ant 🐜
Langton's Ant is a very simple cellular automaton with just two rules. Start with an empty 2D grid and place the ant in the middle. Each frame ant checks color of the cell beneath it.
